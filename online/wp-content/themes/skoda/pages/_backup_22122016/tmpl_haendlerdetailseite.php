...
$leistung = get_field_object('acf_haendler_vertrieb');
...
if( $leistung ): ?>
	...
	<?php foreach( $leistung['choices'] as $value => $label ): ?> 
		<?PHP $umlaute = array( ' ' => '_', '–' => '_', 'Ä' => 'Ae', 'Ö' => 'Oe', 'Ü' => 'Ue', 'ä' => 'ae', 'ö' => 'oe', 'ü' => 'ue', 'ß' => 'ss', '&' => '-');
...
$leistung = get_field_object('acf_haendler_service');
	    ...
	    <h2 class="anchor" id="Mitarbeiter">Unsere Mitarbeiter:</h2><a href="#haendlerdetailseite" title="nach oben" class="jump_to_top hidden-lg"></a>
			...
			<?php while( have_rows('acf_haendler_mitarbeiter') ): the_row(); 
				...
				<div class="col-md-6 col-sm-6 haendler_mitarbeiter min-height-385">
					<img class="img-responsive haendler_mitarbeiter_bild" src="<?php echo $image['url']; ?>" alt="<?php echo $image['alt'] ?>" title="<?php echo $image['title'] ?>" />
					<span class=""><?php echo $name; ?></span>
					<span><?php echo $position_bereich; ?></span>
				    <span class="">Telefon: <?php echo $telefon; ?></span>
