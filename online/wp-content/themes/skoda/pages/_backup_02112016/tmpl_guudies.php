                ...
                <div class="select-map">
                    <div class="mapWrap">
                        <div class="interactiveContainer">
                            <div class="imgBox" style="background-image: url('<?php echo get_template_directory_uri(); ?>/images/guudies_bg.jpg')"></div>
                            <div class="mapMain">
                                <section class="mapHead">
                                    <div>
                                        <div>
                                            <h1>Entdecken sie das Rhein-Main-Gebiet.</h1>
                                        </div>
                                    </div>
                                </section>
...
<header>
<h1>UNSERE AUSFLUGSTIPPS: LAUTER GUUDE IDEEN.</h1>
</header>
...
<div class="row">
    ...
    <br />
    Auf dem weit verzweigten Netz gut ausgebauter Wanderwege kann man ausgedehnte Spaziergänge unternehmen und dabei die schöne Wald&shy;atmos&shy;phäre genießen. Nach so einer ausgiebigen Tour kehrt man dann gern im Feldberghof, dem beliebten Ausflugslokal auf dem Gipfel, ein.<br />
    <br />
...
<dl>
<dt>></dt>
<dd><strong>Bikepark Großer Feldberg</strong><br />
Zwei Downhill-Strecken, jede cirka 1,7 km, rund 150 Höhenmeter</dd>
<dt>></dt>
...
<dd><strong>Mehr Infos: <a href="http://www.taunus.info" target="_blank">www.taunus.info</a></strong></dd>
    ...
    <div class="col-lg-6">
    <img src="<?php echo get_template_directory_uri(); ?>/images/guudies_feldberg.jpg" alt="" class="img-responsive" />
...
<div class="row">
    ...
    <br />
    Auf jeden Fall gehört ein Spaziergang auf der Rheinufer-Promenade zu einem Besuch in Eltville. Rheinaufwärts gelangt man dann unwillkürlich zur kurfürstlichen Burg mit ihrem berühmten Rosengarten. Und auch die Burg Crass, das älteste Bauwerk der Stadt, ist nur einen Katzensprung entfernt.</p>
   ...
   <dl>
    ...
    <div class="col-lg-6 col-lg-pull-6">
                <img src="<?php echo get_template_directory_uri(); ?>/images/guudies_eltville.jpg" alt="" class="img-responsive" />
...
<dl>
<dt>></dt>
<dd><strong>Bummel durch Darmstadt</strong><br />Ein Besuch der Grube Messel lässt sich prima mit einem Abstecher nach Darmstadt verbinden. Für Kunstliebhaber lohnt sich auch ein Besuch der Mathildenhöhe – eines Zentrums des Jugendstils.</dd>
<dt>></dt>
<dd><strong>Mehr Infos: <a href="http://www.grube-messel.de" target="_blank">www.grube-messel.de</a>, <a href="http://www.mathildenhoehe.eu" target="_blank">www.mathildenhoehe.eu</a></strong></dd>
    ...
    <div class="col-lg-6">
    <img src="<?php echo get_template_directory_uri(); ?>/images/guudies_messel.jpg" alt="" class="img-responsive" />
...
<dl>
<dt>></dt>
<dd><strong>Historischer Weihnachtsmarkt</strong><br />
Mit vielen Handwerkern, z.B. Glasbläsern, Keramikern, Korbflechtern, Schmieden u.v.m. Findet an drei Adventswochenenden statt.</dd>
<dt>></dt>
<dd><strong>Mehr Infos: <a href="http://www.www.burg-ronneburg.de" target="_blank">www.burg-ronneburg.de</a></strong></dd>
    ...
    <div class="col-lg-6 col-lg-pull-6">
        <img src="<?php echo get_template_directory_uri(); ?>/images/guudies_ronneburg.jpg" alt="" class="img-responsive" />
...
<div class="tipp_box">
    ...
    <dl>
<dt>></dt>
<dd><strong>Landeshauptstadt Wiesbaden</strong><br />Sehenswerte Innenstadt und eine der ältesten Kurstädte Europas.</dd>
<dt>></dt>
...
<dd><strong>Mehr Infos: <a href="http://www.fasanerie.net" target="_blank">www.fasanerie.net</a>, <a href="http://www.wiesbaden.de" target="_blank">www.wiesbaden.de</a></strong></dd>
    ...
    <div class="col-lg-6">
    <img src="<?php echo get_template_directory_uri(); ?>/images/guudies_wiesbaden.jpg" alt="" class="img-responsive" />
