				...
				<div class="collapse navbar-collapse col-md-9" id="bs-example-navbar-collapse-1">
					...
					<!-- <li><a href="#">Fahrzeuge</a></li> -->
						...
						<ul class="dropdown-menu">
							<li><a href="/guudies/">Ausflugtipps</a></li>
                        ...
                        <div class="interactiveContainer">
                            ...
                            <div class="mapMain">
                                <section class="mapHead">
                                    <div>
                                        <div>
                                            <h1>HHMMMM… ECHT LEGGER!</h1>
                                            <h2>Unsere besten Plätzchenrezepte für die Weihnachtszeit.</h2>
                                        </div>
                                    </div>
                                </section>
...
<section class="section">
    ...
    <br /><br />
    <p>Die beste Weihnachtsplätzjer aus unserer Region.<br />
    <br />
    Für Naschkatze und Weihnachtsengelcher.<br />
    <br />
    Wir zeigen Ihnen hier, welche „Plätzjer“ uns am besten schmecken. Und wir verraten auch, wie man sie macht. <br />
    <br />
    ...
    <li><strong><a href="#HUSARENKRAPFEN">Husarenkarpfen</a></strong></li>
