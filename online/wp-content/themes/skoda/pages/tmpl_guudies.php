...
<head>
	...
	<title>Ausflugtipps - ŠKODA TEAM Rhein-Main</title>
...
<div class="row untenausrichten">
   ...
   <div class="tipp_box">
    ...
    <div class="col-lg-6 col-lg-pull-6 links">
        <img src="<?php echo get_template_directory_uri(); ?>/images/guudies_eltville.jpg" alt="Guudies: Kloster Eberbach" class="img-responsive" />
    </div>
...
<div class="row untenausrichten">
    ...
    <div class="col-lg-6 col-lg-pull-6 links">
        <img src="<?php echo get_template_directory_uri(); ?>/images/guudies_ronneburg.jpg" alt="Guudies: Rauf auf die Ronneburg" class="img-responsive" />
    </div>
...
<div class="row untenausrichten">
    ...
    <div class="col-lg-6 rechts">
        <img src="<?php echo get_template_directory_uri(); ?>/images/guudies_wiesbaden.jpg" alt="Guudies: Tierisch gut: die Fasanerie Wiesbaden" class="img-responsive" />
    </div>
